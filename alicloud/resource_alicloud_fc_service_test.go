		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("alicloud_fc_service.foo", "project", "tf-test-fc-service-basic"),
					resource.TestCheckResourceAttr("alicloud_fc_service.foo", "logstore", "tf-test-fc-service-basic"),
				),
			},
		},
	})
...
func TestAccAlicloudFCService_update(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAlicloudFCServiceVpc(testFCRoleTemplate),
				Check: resource.ComposeTestCheckFunc(
...
func testAlicloudFCServiceVpc(role string) string {
	return fmt.Sprintf(`
provider "alicloud" {
  region = "cn-hongkong"
}
